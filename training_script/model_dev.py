...
"""TODO
Update to this:
https://dev.to/kasperfred/putting-it-all-together---introduction-to-tensorflow-part-5-ein 
"""
...
with tf.Session() as sess:
  ...
  # saver.save(sess, './models/model0', global_step=1000)
  path = saver.save(sess, model_output_path, global_step=1000)
