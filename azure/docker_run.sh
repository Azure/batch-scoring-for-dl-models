...
sudo docker run \
  ...
  -e FS_STYLE_IMG_DIRECTORY=$FS_STYLE_IMG_DIRECTORY \
  -e FS_CONTENT_IMG_DIRECTORY=$FS_CONTENT_IMG_DIRECTORY \
  -e FS_OUTPUT_IMG_DIRECTORY_PREFIX=$FS_OUTPUT_IMG_DIRECTORY_PREFIX \
  -e LOCAL_SCRIPT_FILE=$LOCAL_SCRIPT_FILE \
  -e LOCAL_STYLE_IMG_FILE=$LOCAL_STYLE_IMG_FILE \
