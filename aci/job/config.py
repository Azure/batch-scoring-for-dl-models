...
config['afs_file_share_name']        = os.getenv('AFS_FILE_SHARE_NAME')
config['afs_script_directory']       = os.getenv('AFS_SCRIPT_DIRECTORY')
config['afs_model_directory']        = os.getenv('AFS_MODEL_DIRECTORY')
config['afs_result_directory']       = os.getenv('AFS_RESULT_DIRECTORY')
config['afs_data_directory']         = os.getenv('AFS_DATA_DIRECTORY')
